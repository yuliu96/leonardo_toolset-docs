...
class FUSE_det:
    ...
    def train(
        ...
        data_path: str = "",
        sparse_sample=False,
        top_illu_ventral_det_data: dask.array.Array | np.ndarray | str = None,
        bottom_illu_ventral_det_data: dask.array.Array | np.ndarray | str = None,
        top_illu_dorsal_det_data: dask.array.Array | np.ndarray | str = None,
        bottom_illu_dorsal_det_data: dask.array.Array | np.ndarray | str = None,
        left_illu_ventral_det_data: dask.array.Array | np.ndarray | str = None,
        right_illu_ventral_det_data: dask.array.Array | np.ndarray | str = None,
        left_illu_dorsal_det_data: dask.array.Array | np.ndarray | str = None,
        right_illu_dorsal_det_data: dask.array.Array | np.ndarray | str = None,
        ventral_det_data: dask.array.Array | np.ndarray | str | list[str] = None,
        dorsal_det_data: dask.array.Array | np.ndarray | str | list[str] = None,
        save_path: str = "",
        save_folder: str = "",
    ...
    def train_down_sample(
        ...
        left_illu_dorsal_det_data: dask.array.Array | np.ndarray | str = None,
        right_illu_dorsal_det_data: dask.array.Array | np.ndarray | str = None,
        ventral_det_data: dask.array.Array | np.ndarray | str = None,
        dorsal_det_data: dask.array.Array | np.ndarray | str = None,
        save_path: str = "",
        save_folder: str = "",
        save_separate_results: bool = False,
        z_spacing: float = None,  # axial
